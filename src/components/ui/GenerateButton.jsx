...
const GenerateButton = ({ isGenerating = false, onClick, type = "button", ...props }) => {
  return (
    <StyledWrapper>
      <div className="btn-wrapper">
        <button 
          className={`btn ${isGenerating ? 'generating' : ''}`}
          onClick={onClick}
          type={type}
          {...props}
        >
...
const StyledWrapper = styled.div`
  ...
  @keyframes focused-letter-anim {
    ...
    50% {
      ...
      filter: blur(10px) brightness(150%)
        drop-shadow(-36px 12px 12px var(--primary-light));
    }
  }
  ...
  .btn.generating::before {
    box-shadow:
      ...
      0 -16px 16px -8px var(--primary-20) inset,
      1px 1px 1px #fff3,
      2px 2px 2px #fff1,
      -1px -1px 1px #0002,
      -2px -2px 2px #0001;
  ...
  .btn:active::before {
    box-shadow:
      ...
      0 -16px 16px -8px var(--primary-30) inset,
      1px 1px 1px #fff4,
      2px 2px 2px #fff2,
      -1px -1px 1px #0002,
      -2px -2px 2px #0001;
