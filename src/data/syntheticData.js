...
export const SYNTHETIC_ARTICLES = [
    ...
    {
        id: 'foody-001',
        title: 'FOODY VRINDA: CACHE & PERFORMANCE OPTIMIZATION DEPLOYED',
        category: 'FOODY_VRINDA',
        author: 'SYSTEM_ADMIN',
        content_text: `System update for Foody Vrinda mobile client successfully compiled and deployed. Cache system enabled: local SQLite pre-fetching, static asset caching, and dynamic route preloading are fully operational. Low-end Android devices show an 82% speedup in transition times. Build has zero compiler errors.`,
        tags: ['Optimization', 'SQLite', 'Flutter', 'Performance'],
    ...
    {
        id: 'tours-001',
        title: 'VRINDA TOURS: NEW PILGRIMAGE PATH GENERATOR INTEGRATED',
        category: 'VRINDA_TOURS',
        author: 'SYSTEM_ADMIN',
        content_text: `The Braj Chaurasi Kos interactive routing algorithm is now online. Integrated offline map caching using modern Service Workers for seamless browsing in low-connectivity areas of Braj. Optimized React components to prevent any visual layout flicker.`,
        tags: ['Web', 'Offline Cache', 'Service Worker', 'Braj Tours'],
    ...
    {
        id: 'chitra-001',
        title: 'CHITRA VRINDA: PROGRESSIVE IMAGE LOADER PROTOCOL ACTIVATED',
        category: 'CHITRA_VRINDA',
        author: 'SYSTEM_ADMIN',
        content_text: `Activated progressive resolution loading for all high-fidelity Braj spiritual paintings. Handled media assets using dynamic pre-compiling of render tiles, reducing server bandwidth usage by 40% while preserving ultra-sharp retina display detail.`,
        tags: ['CDN', 'Image Optimization', 'Brutalism', 'Art Gallery'],
