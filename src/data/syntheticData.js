...
export const SYNTHETIC_USERS = [
    ...
    { pos: '011', name: 'PHANTOM_OS', weight: '42,900.12', status: 'OFFLINE' },
    { pos: '012', name: 'CORE_DUMP', weight: '41,550.00', status: 'ACTIVE' },
    { pos: '013', name: 'VOID_WALKER', weight: '39,120.44', status: 'IDLE' },
    { pos: '014', name: 'DATA_GHOST', weight: '37,800.99', status: 'OFFLINE' },
    { pos: '015', name: 'NEON_SOUL', weight: '35,440.21', status: 'ACTIVE' },
    { pos: '016', name: 'BIT_STORM', weight: '33,210.00', status: 'IDLE' },
    { pos: '017', name: 'CYBER_SAGE', weight: '31,900.55', status: 'OFFLINE' },
    { pos: '018', name: 'ROOT_ACCESS', weight: '29,440.88', status: 'ACTIVE' },
    { pos: '019', name: 'LINK_LAYER', weight: '27,110.33', status: 'IDLE' },
    { pos: '020', name: 'SKY_FALL', weight: '25,900.00', status: 'OFFLINE' },
    { pos: '021', name: 'DEEP_DIVE_1', weight: '24,200.41', status: 'ACTIVE' },
    { pos: '022', name: 'NULL_POINTER', weight: '22,110.99', status: 'IDLE' },
    { pos: '023', name: 'STACK_TRACE', weight: '20,440.00', status: 'OFFLINE' },
    { pos: '024', name: 'V_ARCHIVE_2', weight: '18,900.77', status: 'ACTIVE' },
    { pos: '025', name: 'ECHO_STREAM', weight: '16,550.88', status: 'IDLE' },
    { pos: '026', name: 'VOID_REACH', weight: '14,210.44', status: 'OFFLINE' },
    { pos: '027', name: 'GATE_KEEPER', weight: '12,900.11', status: 'ACTIVE' },
    { pos: '028', name: 'SIGNAL_LOST', weight: '11,440.00', status: 'IDLE' },
    { pos: '030', name: 'K_LEVEL_4', weight: '9,550.33', status: 'ACTIVE' },
    { pos: '031', name: 'PHANTOM_2', weight: '8,900.00', status: 'IDLE' },
    { pos: '032', name: 'CORE_ZERO', weight: '7,440.88', status: 'OFFLINE' },
    { pos: '033', name: 'VOID_BORN', weight: '6,210.44', status: 'ACTIVE' },
    { pos: '034', name: 'DATA_BYTE', weight: '5,900.11', status: 'IDLE' },
    { pos: '035', name: 'NEON_LITE', weight: '4,440.00', status: 'OFFLINE' },
    { pos: '036', name: 'BIT_SHIFT', weight: '3,210.99', status: 'ACTIVE' },
    { pos: '037', name: 'CYBER_LORE', weight: '2,900.88', status: 'IDLE' },
    { pos: '038', name: 'ROOT_NODE', weight: '1,440.33', status: 'OFFLINE' },
    { pos: '039', name: 'LINK_0', weight: '900.00', status: 'ACTIVE' },
    { pos: '040', name: 'SKY_WALKER', weight: '800.55', status: 'IDLE' },
    { pos: '041', name: 'DEEP_DIVE_2', weight: '700.11', status: 'OFFLINE' },
    { pos: '042', name: 'NULL_STATE', weight: '600.88', status: 'ACTIVE' },
    { pos: '043', name: 'STACK_VOID', weight: '500.22', status: 'IDLE' },
    { pos: '044', name: 'V_ARCHIVE_3', weight: '400.99', status: 'OFFLINE' },
    { pos: '045', name: 'ECHO_DENSE', weight: '300.00', status: 'ACTIVE' },
    { pos: '046', name: 'VOID_PULSE', weight: '200.44', status: 'IDLE' },
    { pos: '047', name: 'GATE_0', weight: '100.11', status: 'OFFLINE' },
    { pos: '048', name: 'SIGNAL_LINK', weight: '50.88', status: 'ACTIVE' },
    { pos: '049', name: 'USER_BETA', weight: '20.33', status: 'IDLE' },
    { pos: '050', name: 'FINAL_VOID', weight: '10.00', status: 'OFFLINE' },
];
